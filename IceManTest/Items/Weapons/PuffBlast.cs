...
{
	public class PuffBlast : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("This is a Puffy Bow.");
		}

		public override void SetDefaults() {
			item.damage = 20; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			item.ranged = true; // sets the damage type to ranged
			item.width = 40; // hitbox width of the item (40)
			item.height = 20; // hitbox height of the item (20)
		...
		public override Vector2? HoldoutOffset()
		{
			...
			public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
			{
				...
				{
				 item.shoot = ModContent.ProjectileType<CrystalArrow>(); ; // or ProjectileID.FireArrow;
				}
